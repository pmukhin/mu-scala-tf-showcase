...
val protocol = project.in(file("modules/protocol"))
  .settings(
    name := "protocol",
...
val server = project.in(file("modules/server"))
  .settings(
    name := "server",
    libraryDependencies ++= Seq(
...
val client = project.in(file("modules/client"))
  .settings(
    name := "client",
    libraryDependencies ++= Seq(
...
val root = (project in file("."))
  .settings(
    name := "charge-station-authenticator"
  )
